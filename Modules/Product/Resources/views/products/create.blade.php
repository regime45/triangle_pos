                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="product_code">Barcode <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="product_code" required value="{{ old('product_code', $nextCode) }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="product_barcode_symbology" id="barcode_symbology" required>
                                            ...
                                            <option selected value="C128">Code 128</option><option value="C128">Code 128</option>
                            ...
                            <div class="form-row">
                                <div class="col-md-4">
                                 ...
                                 <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="product_price">Markup<span class="text-danger">*</span></label>
                                        <input id="product_markup" type="number" class="form-control" name="product_markup" required value="{{ old('product_markup') }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="product_sku">Part Number</label>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="product_year" value="{{ old('product_year') }}">
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="product_model">Model</label>
                                        <input type="text" class="form-control" name="product_model" value="{{ old('product_model') }}" >
                                    </div>
                                </div>
                                  <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="product_brand">Brand</label>
                                        <input type="text" class="form-control" name="product_brand" value="{{ old('product_brand') }}">
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="product_location">Location/Yard</label>
                                        <input type="text" class="form-control" name="product_location" value="{{ old('product_location') }}" >
                                    </div>
                                </div>
                            </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const markupInput = document.getElementById('product_markup');
    ...
    function calculatePrice() {
        const cost = getNumber(costInput.value);
