...
@section('title', 'Purchase Recieve')

@section('breadcrumb')
<ol class="breadcrumb border-0 m-0">
    <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
    <li class="breadcrumb-item"><a href="{{ route('purchases.index') }}">Purchases</a></li>
    <li class="breadcrumb-item active">Recieve</li>
</ol>
@endsection
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="purchase-form" action="{{ route('purchases.updatepr', $purchase) }}" method="POST">
                        @csrf
                        @method('patch')
                        <div class="form-row">
                            <div class="col-lg-3">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label for="reference">Purchase Invoice <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="prInv" required value="{{ $purchase->prInv }}" >
                                </div>
